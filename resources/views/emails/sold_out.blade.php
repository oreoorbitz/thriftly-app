																			...
																			font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;">
																					...
																					<tr>
																							<td style="padding:10px 0;">
																									We have an important update regarding an item from your watchlist. While we regret to inform you that the item you were interested in is now sold out.
																							</td>
																					</tr>
																					<tr>
																							<td style="padding: 10px 0;">
																									...
																									<table style=" width: 200px; margin:0 auto; font-size: 16px;border-collapse: collapse; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; border:1px solid #ddd;">
																											<tr>
																													<td style="padding: 10px; border:1px solid #ddd;">
																														<a href="https://thriftlydotcom.myshopify.com/products/{{$data['handle']}}" style="display: block;  text-decoration: none; text-align: center;">
																					...
																					<tr>
																							<td style="padding:10px 0;">
																									We wanted to share some exciIng news with you. Despite the item being sold out, we have fantasIc deals and alternaIves that you'll love! Discover these amazing opIons:
																							</td>
																					</tr>
																					<tr>
																					...
																					<tr>
																							<td>
																									...
																									<table style=" min-width: 550px; width: 100%;font-size: 16px;border-collapse: collapse; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; border:1px solid #ddd;">
																											<tr>
																												@foreach($new_arraival as $arraival)
																													<td style="padding: 10px; border:1px solid #ddd; width:150px; vertical-align: top;">
																															<a href="https://thriftlydotcom.myshopify.com/products/{{$arraival['handle']}}" style="display: block;  text-decoration: none; text-align: center;">
																																<img src="{{$arraival['image']['src']}}" align="NF" style="max-width:100%;width: 200px;display: inline-block;margin: 5px 0 0; ">
																					...
																					<tr>
																							<td style="padding:20px 0 10px;">
																									Be sure to act fast so you don’t miss these opportuniIes too because all stock on ThriWly.com is unique 1 of 1 inventory!
																							</td>
																					</tr>
																					<tr>
																							<td style="padding:10px 0;">
																									Thank you for being a valued member of our community. We look forward to serving you with more excepIonal products and exciIng offers in the future.
																							</td>
																					</tr>
																			</table>
																			<table style="
